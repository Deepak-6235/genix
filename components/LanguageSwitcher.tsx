          ...
          <div className="py-2">
            {LANGUAGE_CODES.map((lang) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-100 transition ${language === lang ? 'bg-accent-purple-50 text-accent-purple-700' : 'text-gray-700'
                  }`}
              >
