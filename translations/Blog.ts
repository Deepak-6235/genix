...
export const blogTranslations: Record<LanguageCode, {
  title: string;
  subtitle: string;
  readMore: string;
  viewMore: string;
  ...
  ar: {
    title: 'مقالات منزلية تهمك',
    subtitle: 'نصائح ومعلومات مفيدة حول الصيانة والتحسينات المنزلية',
    ...
    posts: [
      {
        ...
        date: 'April 09, 2022',
        category: 'General Articles Rukn Al-Nakheel',
  ...
  pt: {
    title: 'Artigos Domésticos Que Importam Para Você',
    subtitle: 'Dicas úteis e informações sobre manutenção e melhorias domésticas',
    readMore: 'Ler Mais',
    viewMore: 'Ver Mais',
    posts: [
      {
        ...
        category: 'Artigos Gerais Rukn Al-Nakheel',
  ...
  ja: {
    title: 'あなたにとって重要な家庭記事',
    subtitle: 'メンテナンスと家庭改善に関する有用なヒントと情報',
    readMore: '続きを読む',
    viewMore: 'もっと見る',
    posts: [
      {
  ...
  de: {
    title: 'Hausartikel, Die Für Sie Wichtig Sind',
    subtitle: 'Nützliche Tipps und Informationen über Wartung und Hausverbesserungen',
    readMore: 'Mehr Lesen',
    ...
    posts: [
      {
        ...
        date: '09. April 2022',
        category: 'Allgemeine Artikel Rukn Al-Nakheel',
  ...
  fr: {
    title: 'Articles Domestiques Qui Comptent Pour Vous',
    subtitle: 'Conseils utiles et informations sur la maintenance et les améliorations domiciliaires',
    readMore: 'Lire Plus',
    viewMore: 'Voir Plus',
    posts: [
      {
        ...
        date: '09 Avril 2022',
        category: 'Articles Généraux Rukn Al-Nakheel',
