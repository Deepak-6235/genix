...
import { useServicesContentTranslations, usePestControlContentTranslations } from "@/hooks/useTranslations";
import { useLanguage } from "@/contexts/LanguageContext";

export default function PestControlContent() {
  const t = useServicesContentTranslations();
  const content = usePestControlContentTranslations();
  const { dir } = useLanguage();
  const service = t.services.pestControl;
  return (
