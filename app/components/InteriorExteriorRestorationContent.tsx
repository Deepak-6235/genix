...
import { useServicesContentTranslations, useInteriorExteriorRestorationContentTranslations } from "@/hooks/useTranslations";
import { useLanguage } from "@/contexts/LanguageContext";

export default function InteriorExteriorRestorationContent() {
  const t = useServicesContentTranslations();
  const content = useInteriorExteriorRestorationContentTranslations();
