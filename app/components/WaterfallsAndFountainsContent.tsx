...
import { useServicesContentTranslations, useWaterfallsAndFountainsContentTranslations } from "@/hooks/useTranslations";
import { useLanguage } from "@/contexts/LanguageContext";

export default function WaterfallsAndFountainsContent() {
  const t = useServicesContentTranslations();
  const content = useWaterfallsAndFountainsContentTranslations();
