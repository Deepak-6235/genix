...
import { useServicesContentTranslations, useAirConditionerMaintenanceContentTranslations } from "@/hooks/useTranslations";
import { useLanguage } from "@/contexts/LanguageContext";

export default function AirConditionerMaintenanceContent() {
  const t = useServicesContentTranslations();
  const content = useAirConditionerMaintenanceContentTranslations();
  const { dir } = useLanguage();
  const service = t.services.acMaintenance;
  return (
