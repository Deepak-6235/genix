  ...
  const t = useTopBarTranslations();
    return (
        <div className="relative">
            ...
            <div className="h-1 bg-gradient-to-r from-secondary-400 to-tertiary-400"></div>
            
            {/* Main banner with gradient */}
            <div className="bg-gradient-to-r from-tertiary-500 via-secondary-500 to-primary-600 text-white py-4 shadow-lg">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-wrap items-center justify-center lg:justify-between gap-4 sm:gap-6 lg:gap-8">
                        ...
                        >
                            <div className="flex-shrink-0 w-12 h-12 bg-secondary-300 rounded-full flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex-shrink-0 w-12 h-12 bg-secondary-300 rounded-full flex items-center justify-center shadow-md">
                                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
