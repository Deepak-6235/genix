...
async function main() {
  ...
  // Import and run seedBlogs
  console.log('📦 Importing seed-blogs...');
  const { seedBlogs } = await import('./seeds/blogs');
  await seedBlogs(prisma);

  // Import and run seedFaqs
  console.log('📦 Importing seed-faqs...');
